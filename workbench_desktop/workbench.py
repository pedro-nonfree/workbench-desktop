...
class Workbench:
    ...
    def __init__(self, root):
        ...
        f.close()
        self.lang_path = os.path.join(os.getcwd(), 'lang/lang.json')
        f = open(self.lang_path, 'r', encoding='utf-8')
        self.lang = json.load(f)
        f.close()
        self.set_language()
        self.switch_frame("main_menu")
        self.version = "1.0.0b4"
    ...
    def view_json(self):
        ...
        self.text_area = st.ScrolledText(self._frame, width=80, height=22, font=("Arial", 12))
        ...
        self.button_submit_menu = tk.Button(self._frame, font=('Arial Bold', 12),
                                            ...
                                            text=self.lang["consent_menu"]["submit_button"][
                                                self.config["language"]])

        self.title_view_json.grid(row=0, column=0, pady=20)
        self.button_submit_menu.grid(row=2, column=0, pady=(0, 20))
    ...
    def final_page(self, result):
        ...
        if result < 0:
            ...
            self.button_retry = tk.Button(self._frame, font=('Arial Bold', 12),
                                          command=lambda: self.switch_frame("main_menu"),
                                          width=50, height=2,
...
if __name__ == "__main__":
    ...
    main_win.title("eReuse.org - Workbench Desktop")
    windowWidth = 1080
    windowHeight = 720
